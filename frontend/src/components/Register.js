...
const Register = () => {
    ...
    return (
        <div className="register-container container-container">
            <div className="content">
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <input value={whatsapp} onChange={e => setWhatsapp(e.target.value)} placeholder="Whatsapp" type="number"/>

                    <div className="input-group">
                        <input value={city} onChange={e => setCity(e.target.value)} placeholder="Cidade" type="text"/>
                        <input value={uf} onChange={e => setUf(e.target.value)} placeholder="UF" type="text" style={{ width: 80}} />
                    </div>
